...
public class MainActivityTest{
    ...
    public void checkList(){
        ...
        solo.enterText((EditText) solo.getView(R.id.editText_name), "Emran_72");
        ...
        /* True if there is any text: Emran_72 on the screen, wait at least 2 seconds and
        find minimum one match. */
        assertTrue(solo.waitForText("Emran_72", 1, 2000));

        solo.clickOnButton("ClEAR ALL"); //Select ClEAR ALL
        //True if there is no text: Emran_72 on the screen
        assertFalse(solo.searchText("Emran_72"));
    ...
    public void checkCiyListItem(){
        ...
        solo.waitForText("Emran_72", 1, 2000);
